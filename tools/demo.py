...
CLASSES = ('__background__', # always index 0
            # number of person classes: 24 + 1 bg
            'TStrobl', 'THazard', 'TJantschke', 'JBezos', 'MThatcher', 'SBender', 'ADragovic', 'FMladenovic', 
            'NKovac', 'MZuckerberg', 'HGenscher', 'SHuszti', 'RWeizsaecker', 'AHallaschka', 'MDoucoure', 
            'MHasebe', 'MHummels', 'FBobic', 'JKoo', 'JKlopp', 'HClinton', 'MGorbatschow', 'KRummenigge', 'HFischer')
#'''

NETS = {'vgg16': ('VGG16', 'VGG16_faster_rcnn_person24cls_final.caffemodel'),
        'zf': ('ZF', 'ZF_faster_rcnn_person24cls_final.caffemodel')}
...
if __name__ == '__main__':
    ...
    prototxt = os.path.join(cfg.MODELS_DIR, NETS[args.demo_net][0],'faster_rcnn_end2end', 'test_person.24cls.prototxt')    
    caffemodel = os.path.join(cfg.DATA_DIR, 'person_models', NETS[args.demo_net][1])
